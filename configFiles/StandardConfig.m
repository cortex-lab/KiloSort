...
ops.fbinary             = 'F:\DATA\Spikes\set6\20141202_all_GT.dat'; % will be created for 'openEphys'
ops.fproc               = 'F:\DATA\Spikes\temp_wh.dat'; % residual from RAM of preprocessed data
ops.root                = 'F:\DATA\Spikes\Piroska'; % 'openEphys' only: where raw files are
...
ops.chanMap             = 'F:\DATA\Spikes\forPRBimecToWhisper.mat'; % make this file using createChannelMapFile.m
